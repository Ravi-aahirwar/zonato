...
let SearchBar = ({handleChanged,query}) => {
return <div className={css.outerDiv}>
        ...
        <div className={css.srch2}>
            ...
            <input onChange={handleChanged} value={query} type="text" placeholder='Search for restaurant, cuisine or a dish' className={css.inpt} />
        </div>
