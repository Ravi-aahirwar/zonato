...
let Signup = ({ setAuth }) => {
        ...
        <div className={signupCss.modal}>
            ...
            <div className={signupCss.lgBox}>
                ...
                <input className={signupCss.inpBox} type='password' placeholder='Password ...' />
                <span className={signupCss.termsTxt}>
                    <input type="checkbox" name="accpect" id="accpect" className={signupCss.checkBox} />
                    <span>
                        I agree to Zonato's <a href="" className={signupCss.termaAnchor}>Terms of Service, Privacy Policy</a> and <a href="" className={signupCss.termaAnchor}>Content Policies</a>
                    </span>
                </span>
